...
class UpProject(nn.Module):
    ...
    def forward(self, x):
        # (1,1,1,1) means pad along (padding_left,padding_right,padding_top,padding_bottom) with 1 pixel
        ...
        # out1_1.size() = ([32, 512, 8, 10]) = (batchsize, channel, height, width)
        # out1_2.size() = ([32, 512, 8, 10])
        # after stack size = ([32, 512, 2, 8, 10])
        # after permute size = ([32, 512, 8, 10, 2])
        # contiguous is used to ensure the address of the variable is contiguous
        # after contiguous size = ([32, 512, 8, 10, 2])
        # after view size = ([32, 512, 8, 20])
        ...
        # after stack size = ([32, 512, 2, 8, 20])
        # after permute size = ([32, 512, 8, 2, 20])
        # after view size = ([32, 512, 16, 20])
